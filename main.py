...
diagT.grid(row=8, column=12, padx=2, pady=2)

message_button = Button(text="Выполнить", command=calculate)
message_button.grid(row=5, column=11, padx=5, pady=5, sticky="e")
fak_button = Button(text="Графики возмущений", command=get_faks_image)
fak_button.grid(row=6, column=11, padx=5, pady=5, sticky="e")
graf_button = Button(text="Графики", command=get_graphics)
graf_button.grid(row=7, column=11, padx=5, pady=5, sticky="e")
diag_button = Button(text="Диаграммы", command=get_diag)
diag_button.grid(row=8, column=11, padx=5, pady=5, sticky="e")
