...
fak_f = {'FaK1': fak1, 'FaK2': fak2, 'FaK3': fak3, 'FaK4': fak4, 'FaK5': fak5}
res = {}
...
def get_graphics():
    ...
    legend_labels = []
    for i in range(10):
        plt.plot(t, res[params[i].label], linewidth=3)
...
m0 = Label(text="Качество:")
m1 = Label(text="Корректность:")
m2 = Label(text="Надежность:")
m3 = Label(text="Эффективность:")
m4 = Label(text="Прослеживоемость:")
m5 = Label(text="Функциональная полнота:")
m6 = Label(text="Последовательность:")
m7 = Label(text="Правильность:")
m8 = Label(text="Устойчивость:")
m9 = Label(text="Эффективность:")
...
x12.grid(row=0, column=5, sticky="w")
x21.grid(row=1, column=7, sticky="w")
x22.grid(row=1, column=5, sticky="w")
x31.grid(row=2, column=7, sticky="w")
x32.grid(row=2, column=5, sticky="w")
x41.grid(row=3, column=7, sticky="w")
x42.grid(row=3, column=5, sticky="w")
x51.grid(row=4, column=7, sticky="w")
x52.grid(row=4, column=5, sticky="w")
...
a20.grid(row=0, column=7, padx=5, pady=5)
a21.grid(row=4, column=7, padx=5, pady=5)
a22.grid(row=1, column=7, padx=2, pady=2)
a23.grid(row=2, column=7, padx=5, pady=5)
a24.grid(row=3, column=7, padx=2, pady=2)
